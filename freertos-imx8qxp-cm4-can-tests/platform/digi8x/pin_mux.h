...
#define BOARD_INITPINS_BB_SPI0_SCK_PIN_FUNCTION_ID	SC_P_SPI0_SCK
#define BOARD_INITPINS_BB_SPI0_SDI_PIN_FUNCTION_ID	SC_P_SPI0_SDI
#define BOARD_INITPINS_BB_SPI0_SDO_PIN_FUNCTION_ID	SC_P_SPI0_SDO

/* chip select lines for mcp2517 controllers */
#define BOARD_INITPINS_BB_SPI0_CS0_PIN_FUNCTION_ID	SC_P_SPI0_CS0
#define BOARD_INITPINS_BB_SPI0_CS1_PIN_FUNCTION_ID	SC_P_SPI0_CS1
#define BOARD_INITPINS_BB_SPI0_CS2_PIN_FUNCTION_ID	SC_P_USDHC1_RESET_B
#define BOARD_INITPINS_BB_SPI0_CS3_PIN_FUNCTION_ID	SC_P_USDHC1_VSELECT
